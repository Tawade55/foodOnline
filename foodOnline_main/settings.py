...
STATIC_URL = 'static/'
STATIC_ROOT=BASE_DIR/'static'	#yath STATIC_ROOT manje foodOnline chya aath Base Directory aahe ti manje foodOnline_main ani tichya aath static files ahet
STATICFILES_DIRS=[		
